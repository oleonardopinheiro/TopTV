  ...
  var t = {
          ...
          return (
            !s &&
              ...
              r.addEventListener(
                i,
                (e = function () {
                  for (r.removeEventListener(i, e), s = 1; (e = n.shift()); )
                    e()
                })
              ),
            function (t) {
      ...
      412: (t, e, n) => {
        ...
        'function' != typeof m.Promise
          ? (m.Promise = v)
          : (m.Promise.prototype.finally || (m.Promise.prototype.finally = r),
            m.Promise.allSettled || (m.Promise.allSettled = o))
      },
      42: (t, e, n) => {
        'use strict'
                ...
                return (
                  (u._initPromise = (0, o.request)(
                    ...
                    .then(function (t) {
                      ...
                      return (
                        delete e.features,
                        u.init((0, o.mergeDeep)(n, e), n.features),
                        e &&
                          e.key &&
                          (0, r.trackOptions)(u.options, Object.keys(e)),
                        s && s(void 0, u),
              ...
              (t.prototype.createWidget = function (t, e, n) {
                ...
                return (
                  ...
                  (0, o.request)(
                    ...
                    return (
                      delete e.features,
                      l.init((0, o.mergeDeep)(u, e), u.features),
                      e &&
                        e.key &&
                        (0, r.trackOptions)(l.options, Object.keys(e)),
                      l
                    )
                  })
                )
          ...
          c = (function () {
            ...
            return (
              (t.prototype.setOptions = function (t) {
                return (
                  (this.options = (0, s.mergeDeep)(this.options, t)),
                  this.features &&
              ...
              (t.prototype.renderFrame = function (t, e) {
                ...
                3 === this.options.widgetVersion
                  ? this.renderFrameV3(n, e)
                  : this.renderFrameV2(n),
                  t.appendChild(n),
                  ...
                  var n,
                    ...
                    a =
                      null !== (n = t.contentDocument) && void 0 !== n
                        ? n
                        : null === (i = t.contentWindow) || void 0 === i
                        ? void 0
                        : i.document
              ...
              (t.prototype.renderFrameV3 = function (t, e) {
                var n = this,
                  i = document.createElement('div')
                ;(i.id = 'smartsupp-widget-container'),
                  e.appendChild(i),
                  t.addEventListener('load', function () {
                    var e,
                      i,
                      a =
                        null !== (e = t.contentDocument) && void 0 !== e
                          ? e
                          : null === (i = t.contentWindow) || void 0 === i
                          ? void 0
                          : i.document
                    ...
                    ;(u.id = 'body'),
                      ...
                      (u.innerHTML = '<div id="app"></div>')
                    var l = 'src/main.ts',
                      p = function (t) {
                        var e = (0, s.createScript)(
                          a,
                          n.getBaseUrl() + '/'.concat(t)
                        )
                        ;(e.type = 'module'), c.appendChild(e)
                      },
                      d = function (t) {
                        var e = (0, s.createLink)(
                          a,
                          ''.concat(n.getBaseUrl(), '/').concat(t)
                        )
                        ;(e.rel = 'stylesheet'), c.appendChild(e)
                      }
                    !0 === n.options.widgetV3DevMode
                      ? ['@vite/client', l].forEach(p)
              ...
              (t.prototype.getBaseUrl = function () {
                return 3 === this.options.widgetVersion
                  ? this.options.widgetV3Url
                  : this.options.widgetV2Url
              }),
                    ...
                    (this._pushApi.forEach(function (n) {
                      ...
                      try {
                        e.options.widgetTrackerEnabled &&
                          (0, i.trackOperation)(e.options, r[0]),
                          t.execute(r)
                      } catch (t) {
                        console.log(t)
                      }
  ...
  ;(n.g = (function () {
    ...
    (() => {
      ...
      if (
        ...
        ;(window.$smartsupp = r),
          (window.smartsupp = Object.assign(window.smartsupp, {
            chats: r.widgets,
